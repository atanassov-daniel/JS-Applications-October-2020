...
let a = Array.from(document.querySelectorAll("script"))
let found = a.find(el => {
    if (el.attributes.src && el.attributes.src.value === "./app.js") {
        return el;
    }
});
found.type = "module";
import weatherSymbols from "./helperFunctions copy.js";
//console.log(weatherSymbols);
